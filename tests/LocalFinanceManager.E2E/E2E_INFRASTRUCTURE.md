...
Where `{fixtureId}` is a unique identifier per test fixture (typically a GUID or similar unique value generated by `TestWebApplicationFactory`).

Example: `localfinancemanager.e2etest.fixture_a1b2c3d4.db`
